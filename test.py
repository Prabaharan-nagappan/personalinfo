from src.personalinfo import PersonalInfoSaver, FamilyDetails

# Create the saver object
saver = PersonalInfoSaver()

# Save user information with all fields and structured family details
prabaharan_family = FamilyDetails(
    father="S. Kumar",
    mother="L. Devi",
    siblings="R. Prakash"
)
saver.save_info(
    ...
    blood_group="O+",
    family_details=prabaharan_family.to_dict(),
