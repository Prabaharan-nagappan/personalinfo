...
class EducationDetails:
    """
    Used to store and retrieve education details for a person, including schooling and more fields.
    """
...
class PersonalInfoSaver:
    ...
    email, height, weight, BMI (auto-calculated), BMI description, bio, blood group, family details, aadhar number, address, vehicles, and education.
    """
...
# Example usage (should be moved to a separate test or demo script in production)
if __name__ == "__main__":
    ...
    personal.save_info(
        ...
        education_details=[ug, hsc, schooling]
    )
